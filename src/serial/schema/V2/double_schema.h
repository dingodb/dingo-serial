...
#ifndef DINGO_SERIAL_DOUBLE_SCHEMA_V2_H_
#define DINGO_SERIAL_DOUBLE_SCHEMA_V2_H_
...
class DingoSchema<double> : public BaseSchema {
 public:
  ...
  BaseSchemaPtr Clone() override {
    return std::make_shared<DingoSchema<double>>();
  }
 ...
 private:
  ...
  double DecodeDoubleNotComparable(Buf& buf, int offset);
};
