...
#ifndef DINGO_SERIAL_BASE_SCHEMA_V2_H_
#define DINGO_SERIAL_BASE_SCHEMA_V2_H_
...
class BaseSchema;
using BaseSchemaPtr = std::shared_ptr<serialV2::BaseSchema>;
...
class BaseSchema {
 public:
  ...
  virtual int GetLengthForKey() = 0;
  virtual int GetLengthForValue() = 0;
