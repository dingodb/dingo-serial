...
int DingoSchema<std::string>::EncodeBytesComparable(const std::string& data,
                                                    Buf& buf) {
...
int DingoSchema<std::string>::DecodeBytesComparable(Buf& buf,
                                                    std::string& data) {
  int size = 0;
  for (;;) {
...
int DingoSchema<std::string>::EncodeBytesNotComparable(const std::string& data,
                                                       Buf& buf) {
